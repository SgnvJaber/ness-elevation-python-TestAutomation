...
class Test_Building_Test_Case():
    ...
    def test_01(self):
        ...
        driver.find_element(By.XPATH, "//*[@text='Make Payment']").click()
        driver.find_element(By.XPATH, "//*[@id='phoneTextField']").send_keys("0525663961")
        driver.find_element(By.XPATH, "//*[@id='nameTextField']").send_keys("Saed")
        driver.find_element(By.XPATH, "//*[@id='amountTextField']").send_keys("300")
        driver.find_element(By.XPATH, "//*[@text='Select']").click()
        driver.find_element(By.XPATH, "//*[@text='New Zealand']").click()
        driver.find_element(By.XPATH, "//*[@text='Send Payment']").click()
        driver.find_element(By.XPATH, "//*[@text='Yes']").click()
